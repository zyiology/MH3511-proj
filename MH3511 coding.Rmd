...
substemp.folder <- 'C:/Users/ancel/Downloads/subsurfacetempfiles/subsurfacetempfiles/'
...
adf.test(lat) #if p < 0.05, reject, stationary
kpss.test(lat) #if p < 0.05, reject, not stationary
